...
namespace UP___Skaner
{
    public partial class Skaner : Form
    {
        ...
        private int cmXSize = 8;
        private int cmYSize = 8;
        private int startcmXSize = 0;
        private int startcmYSize = 0;
        private int color = 1;
        ...
        private void textBoxPositionX_TextChanged(object sender, EventArgs e)
        {
            try
            {
                startcmXSize = Int32.Parse(textBoxPositionX.Text);
                startX = CentimetersToPixels(startcmXSize, dpi);
            }
            catch (Exception ex)
            {
                MessageBox.Show("An error occurred: " + ex.Message, "Error",
        ...
        private void textBoxPositionY_TextChanged(object sender, EventArgs e)
        {
            try
            {
                startcmYSize = Int32.Parse(textBoxPositionY.Text);
                startY = CentimetersToPixels(startcmYSize, dpi);
            }
            catch (Exception ex)
            {
                MessageBox.Show("An error occurred: " + ex.Message, "Error",
